...
def build_path_profile_ap():
	...
	build_path_profile_ap = path+"logFiles"+os.sep+"profile_ap"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_profile_ap):
		os.makedirs(build_path_profile_ap)

	return build_path_profile_ap

if __name__ == "__main__":
	path = build_path_profile_ap()
	print path
