...
def build_path_links_usqa():
	...
	build_path_links_usqa = path+"logFiles"+os.sep+"links_usqa"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_links_usqa):
		os.makedirs(build_path_links_usqa)

	return build_path_links_usqa

if __name__ == "__main__":
	path = build_path_links_usqa()
	print path
