...
def build_path_profile_patch():
	...
	build_path_profile_patch = path+"logFiles"+os.sep+"profile_patch"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_profile_patch):
		os.makedirs(build_path_profile_patch)

	return build_path_profile_patch

if __name__ == "__main__":
	path = build_path_profile_patch()
	print path
