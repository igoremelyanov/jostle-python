...
def build_path_Privacy_patchnew(self,servername,is_started):
	...
	self.build_path = path+"logFiles"+os.sep+"Privacy_patch_"+servername+os.sep+"buildData"+os.sep+self.Build+os.sep
...
if __name__ == "__main__":
	...
	print context.build_path_Privacy_patchnew
