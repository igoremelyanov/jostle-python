...
def build_path_links_ap():
	...
	build_path_links_ap = path+"logFiles"+os.sep+"links_ap"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_links_ap):
		os.makedirs(build_path_links_ap)

	return build_path_links_ap

if __name__ == "__main__":
	path = build_path_links_ap()
	print path
