...
def build_path_MarketplaceGoogleApp_usqa():
	...
	build_path_MarketplaceGoogleApp_usqa = path+"logFiles"+os.sep+"MarketplaceGoogleApp_usqa"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_MarketplaceGoogleApp_usqa):
		os.makedirs(build_path_MarketplaceGoogleApp_usqa)

	return build_path_MarketplaceGoogleApp_usqa

if __name__ == "__main__":
	path = build_path_MarketplaceGoogleApp_usqa()
	print path
