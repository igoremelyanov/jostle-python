...
def build_path_Teams_patch():
	...
	teams_buildPath_patch = path+"logFiles"+os.sep+"Teams_patch"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(teams_buildPath_patch):
		os.makedirs(teams_buildPath_patch)

	return teams_buildPath_patch

if __name__ == "__main__":
	path = build_path_Teams_patch()
	print path
