...
def build_path_people1_usqa():
	...
	build_path_people1_usqa = path+"logFiles"+os.sep+"people1_usqa"+os.sep+"buildData"+os.sep+Build+os.sep
	if not os.path.exists(build_path_people1_usqa):
		os.makedirs(build_path_people1_usqa)

	return build_path_people1_usqa

if __name__ == "__main__":
	path = build_path_people1_usqa()
	print path