...
def build_path_ca():
	...
	driver.implicitly_wait(15)         	#sets a general time to wait for an element to be found.
	...
	buildPath_CA = path+"logFiles"+os.sep+"adminPages_caqa"+os.sep+"buildData"+os.sep+Build+os.sep
