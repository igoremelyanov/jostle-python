...
def build_path_people1_patch(self,servername,is_started):
	#def build_path_people1_patch(self,servername,is_started):
	...
	self.build_path = path+"logFiles"+os.sep+"people1_"+servername+os.sep+"buildData"+os.sep+self.Build+os.sep
...
# 	print context.build_path_people1_patch
